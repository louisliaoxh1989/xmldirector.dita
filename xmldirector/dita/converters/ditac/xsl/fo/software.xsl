...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="msgblock"
    ...
    <xsl:attribute name="background-color">#E8F0F8</xsl:attribute>
    <!-- Add actual border using the frame attribute. -->
    <xsl:attribute name="border-color">#C8D0E8</xsl:attribute>
  ...
  <xsl:attribute-set name="systemoutput" use-attribute-sets="monospace-style">
    <xsl:attribute name="background-color">#F0F8F0</xsl:attribute>
  </xsl:attribute-set>
