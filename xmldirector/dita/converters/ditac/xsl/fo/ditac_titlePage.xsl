...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="title-page">
    <xsl:attribute name="margin">1.33em</xsl:attribute>
  ...
  <xsl:attribute-set name="document-title"
    ...
    <xsl:attribute name="line-height">1</xsl:attribute><!--Not 0.67-->
  ...
  <xsl:attribute-set name="booktitlealt"
    ...
    <xsl:attribute name="space-before.optimum">2.22em</xsl:attribute>
    <xsl:attribute name="space-before.minimum">2.1em</xsl:attribute>
    <xsl:attribute name="space-before.maximum">2.3em</xsl:attribute>
    <xsl:attribute name="space-after.optimum">2.22em</xsl:attribute>
    <xsl:attribute name="space-after.minimum">2.1em</xsl:attribute>
    <xsl:attribute name="space-after.maximum">2.3em</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="personinfo" use-attribute-sets="block-style">
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="emailaddress"
                     use-attribute-sets="link-style monospace-style">
  </xsl:attribute-set>
