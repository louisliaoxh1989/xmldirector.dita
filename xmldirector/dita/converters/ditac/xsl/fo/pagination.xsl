...
<!--
| Copyright (c) 2009-2016 Pixware SARL. All rights reserved.
|
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="title-first-page">
  ...
  <xsl:template name="layoutMasterSet">
    <fo:layout-master-set>
      ...
      <fo:simple-page-master master-name="blank-page"
        ...
        <fo:region-body margin-top="{$body-top-margin}"
          ...
          <xsl:call-template name="addWatermark">
            <xsl:with-param name="pageMasterType" select="'blank'"/>
          </xsl:call-template>
        </fo:region-body>
      ...
      <fo:simple-page-master master-name="title-first-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
        ...
        <xsl:choose>
          <xsl:when test="$foProcessor eq 'XEP'">
            ...
            <fo:region-body margin-top="{$body-top-margin}"
                            margin-bottom="{$body-bottom-margin}"
                            xsl:use-attribute-sets="title-first-page">
              <xsl:call-template name="addWatermark">
                <xsl:with-param name="pageMasterType" select="'title'"/>
              </xsl:call-template>
            </fo:region-body>
          </xsl:when>
          <xsl:otherwise>
      ...
      <fo:simple-page-master master-name="title-odd-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="title-even-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="toc-first-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
        ...
        <fo:region-body margin-top="{$body-top-margin}"
                        margin-bottom="{$body-bottom-margin}">
          <xsl:call-template name="addWatermark">
            <xsl:with-param name="pageMasterType" select="'toc'"/>
          </xsl:call-template>
        </fo:region-body>
        <fo:region-before extent="{$header-height}"
                          display-align="before"
      ...
      <fo:simple-page-master master-name="toc-even-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="booklist-first-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
        ...
        <fo:region-body margin-top="{$body-top-margin}"
                        margin-bottom="{$body-bottom-margin}">
          <xsl:call-template name="addWatermark">
            <xsl:with-param name="pageMasterType" select="'booklist'"/>
          </xsl:call-template>
        </fo:region-body>
        <fo:region-before extent="{$header-height}"
                          display-align="before"
      ...
      <fo:simple-page-master master-name="booklist-odd-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="booklist-even-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="frontmatter-first-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
        ...
        <fo:region-body margin-top="{$body-top-margin}"
                        margin-bottom="{$body-bottom-margin}">
          <xsl:call-template name="addWatermark">
            <xsl:with-param name="pageMasterType" select="'frontmatter'"/>
          </xsl:call-template>
        </fo:region-body>
        <fo:region-before extent="{$header-height}"
                          display-align="before"
      ...
      <fo:simple-page-master master-name="frontmatter-odd-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="frontmatter-even-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="body-first-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
        ...
        <fo:region-body margin-top="{$body-top-margin}"
                        margin-bottom="{$body-bottom-margin}">
          <xsl:call-template name="addWatermark">
            <xsl:with-param name="pageMasterType" select="'body'"/>
          </xsl:call-template>
        </fo:region-body>
        <fo:region-before extent="{$header-height}"
                          display-align="before"
      ...
      <fo:simple-page-master master-name="body-odd-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="body-even-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="backmatter-first-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
        ...
        <fo:region-body margin-top="{$body-top-margin}"
                        margin-bottom="{$body-bottom-margin}">
          <xsl:call-template name="addWatermark">
            <xsl:with-param name="pageMasterType" select="'backmatter'"/>
          </xsl:call-template>
        </fo:region-body>
        <fo:region-before extent="{$header-height}"
                          display-align="before"
      ...
      <fo:simple-page-master master-name="backmatter-odd-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="backmatter-even-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
      ...
      <fo:simple-page-master master-name="index-first-page"
                             page-width="{$page-width}"
                             page-height="{$page-height}"
                             margin-top="{$page-top-margin}"
                             margin-bottom="{$page-bottom-margin}"
        ...
        <fo:region-body margin-top="{$body-top-margin}"
          ...
          <xsl:call-template name="addWatermark">
            <xsl:with-param name="pageMasterType" select="'index'"/>
          </xsl:call-template>
        </fo:region-body>
        <fo:region-before extent="{$header-height}"
                          display-align="before"
      ...
      <!-- page-sequence-masters (two-sided) ============================= -->
      ...
      <fo:page-sequence-master master-name="title">
        <fo:repeatable-page-master-alternatives>
          ...
          <fo:conditional-page-master-reference 
            master-reference="title-first-page"
            page-position="first"/>
          <fo:conditional-page-master-reference
            master-reference="title-odd-page"
            odd-or-even="odd"/>
          <fo:conditional-page-master-reference 
            odd-or-even="even" 
            master-reference="title-even-page"/>
        </fo:repeatable-page-master-alternatives>
      ...
      <fo:page-sequence-master master-name="toc">
        <fo:repeatable-page-master-alternatives>
          <fo:conditional-page-master-reference 
            ...
            blank-or-not-blank="blank"/>
          <fo:conditional-page-master-reference 
            master-reference="toc-first-page"
            page-position="first"/>
          <fo:conditional-page-master-reference
      ...
      <fo:page-sequence-master master-name="booklist">
        <fo:repeatable-page-master-alternatives>
          <fo:conditional-page-master-reference 
            ...
            blank-or-not-blank="blank"/>
          <fo:conditional-page-master-reference 
            master-reference="booklist-first-page"
            page-position="first"/>
          <fo:conditional-page-master-reference
            master-reference="booklist-odd-page"
            odd-or-even="odd"/>
          <fo:conditional-page-master-reference 
            odd-or-even="even" 
            master-reference="booklist-even-page"/>
        </fo:repeatable-page-master-alternatives>
      </fo:page-sequence-master>
      ...
      <fo:page-sequence-master master-name="frontmatter">
        <fo:repeatable-page-master-alternatives>
          <fo:conditional-page-master-reference 
            ...
            blank-or-not-blank="blank"/>
          <fo:conditional-page-master-reference 
            master-reference="frontmatter-first-page"
            page-position="first"/>
          <fo:conditional-page-master-reference
            master-reference="frontmatter-odd-page"
            odd-or-even="odd"/>
          <fo:conditional-page-master-reference 
            odd-or-even="even" 
            master-reference="frontmatter-even-page"/>
        </fo:repeatable-page-master-alternatives>
      </fo:page-sequence-master>
      ...
      <fo:page-sequence-master master-name="body">
        <fo:repeatable-page-master-alternatives>
          <fo:conditional-page-master-reference 
            ...
            blank-or-not-blank="blank"/>
          <fo:conditional-page-master-reference 
            master-reference="body-first-page"
            page-position="first"/>
          <fo:conditional-page-master-reference
            master-reference="body-odd-page"
            odd-or-even="odd"/>
          <fo:conditional-page-master-reference 
            odd-or-even="even" 
            master-reference="body-even-page"/>
        </fo:repeatable-page-master-alternatives>
      </fo:page-sequence-master>
      ...
      <fo:page-sequence-master master-name="backmatter">
        <fo:repeatable-page-master-alternatives>
          <fo:conditional-page-master-reference 
            ...
            blank-or-not-blank="blank"/>
          <fo:conditional-page-master-reference 
            master-reference="backmatter-first-page"
            page-position="first"/>
          <fo:conditional-page-master-reference
            master-reference="backmatter-odd-page"
            odd-or-even="odd"/>
          <fo:conditional-page-master-reference 
            odd-or-even="even" 
            master-reference="backmatter-even-page"/>
        </fo:repeatable-page-master-alternatives>
      </fo:page-sequence-master>
      ...
      <fo:page-sequence-master master-name="index">
        <fo:repeatable-page-master-alternatives>
          <fo:conditional-page-master-reference 
            ...
            blank-or-not-blank="blank"/>
          <fo:conditional-page-master-reference 
            master-reference="index-first-page"
            page-position="first"/>
          <fo:conditional-page-master-reference
            master-reference="index-odd-page"
            odd-or-even="odd"/>
          <fo:conditional-page-master-reference 
            odd-or-even="even" 
            master-reference="index-even-page"/>
        </fo:repeatable-page-master-alternatives>
      </fo:page-sequence-master>
  ...
  <xsl:template name="addWatermark">
    <xsl:param name="pageMasterType" select="''"/>

    <xsl:if test="$watermarkImageName ne '' and
                  (index-of($watermarkList, 'all') ge 1 or 
                   index-of($watermarkList, $pageMasterType) ge 1)">
      <xsl:attribute name="background-image"
        select="concat('url(', resolve-uri($watermark-image, URI:userDirectory()), ')')"/>
      <xsl:attribute name="background-attachment" select="'fixed'"/>
  ...
  <xsl:template name="configurePageSequence">
    ...
    <xsl:variable name="masterName" 
                  select="u:pageMasterName($sequenceName, $frontmatterNames,
  ...
  <xsl:function name="u:pageMasterName" as="xs:string">
    ...
    <xsl:variable name="masterNamePrefix">
      <xsl:choose>
        <xsl:when test="$type eq 'titlePage'">
          <xsl:value-of select="'title'"/>
        </xsl:when>
        <xsl:when test="$type eq 'toc'">
          <xsl:value-of select="'toc'"/>
        </xsl:when>
        <xsl:when test="$type eq 'figureList' or 
                        $type eq 'tableList' or 
                        $type eq 'exampleList'">
          <xsl:value-of select="'booklist'"/>
        </xsl:when>
        <xsl:when test="$type eq 'indexList'">
          <xsl:value-of select="'index'"/>
        </xsl:when>
        <xsl:when test="$type eq 'part' or
                        $type eq 'chapter' or
                        $type eq 'appendices' or
                        $type eq 'appendix' or
                        $type eq 'section1' or
                        $type eq 'section2' or
                        $type eq 'section3' or
        ...
        <xsl:otherwise>
          <!-- Frontmatter or backmatter other than toc, figureList, etc. That
               ...
               glossarylist. -->
          <xsl:value-of
            select="if (index-of($frontmatterNames, $sequenceName) ge 1) 
                    then 'frontmatter' 
                    else 'backmatter'"/>
        </xsl:otherwise>
      </xsl:choose>
    ...
    <xsl:sequence select="if ($two-sided eq 'yes') 
                          then $masterNamePrefix
                          else concat($masterNamePrefix, '-odd-page')" />
  </xsl:function>
  ...
  <xsl:template name="configureHyphenate">
    ...
    <xsl:choose>
      <xsl:when test="starts-with($masterName, 'body') or 
                      starts-with($masterName, 'frontmatter') or 
                      starts-with($masterName, 'backmatter')">
  ...
  <xsl:function name="u:startsOnOddPage" as="xs:boolean">
    ...
    <xsl:variable name="prevSequenceName" 
                  select="u:prevSequenceName($sequenceName, $frontmatterNames, 
                                             $bodyNames, $backmatterNames)"/>

    <xsl:sequence
        select="$type eq 'part' or
                $type eq 'chapter' or
                $type eq 'appendices' or
                $type eq 'appendix' or
                $prevSequenceName eq '' or
                (u:pageMasterName($sequenceName, $frontmatterNames,
                                  $bodyNames, $backmatterNames) ne
                 u:pageMasterName($prevSequenceName, $frontmatterNames,
                                  $bodyNames, $backmatterNames))"/>
  </xsl:function>

  <xsl:function name="u:prevSequenceName" as="xs:string">
    <xsl:param name="sequenceName" as="xs:string"/>
    <xsl:param name="frontmatterNames" as="xs:string*"/>
    <xsl:param name="bodyNames" as="xs:string*"/>
    <xsl:param name="backmatterNames" as="xs:string*"/>
    ...
    <xsl:sequence select="if ($pos ge 2) 
                          then $list[$pos - 1]
                          else ''"/>
  </xsl:function>
  ...
  <xsl:template name="configureForcePageCount">
    ...
    <xsl:attribute name="force-page-count" 
                   select="if ($two-sided eq 'yes' and
                               $nextSequenceName ne '' and
  ...
  <xsl:function name="u:nextSequenceName" as="xs:string">
    ...
    <xsl:variable name="pos" select="index-of($list, $sequenceName)"/>
    <xsl:sequence 
      select="if ($pos ge 1 and $pos lt count($list)) 
              then $list[$pos + 1]
              else ''"/>
  </xsl:function>
  ...
  <xsl:template name="configureFormat">
    ...
    <xsl:attribute name="format" 
                   select="if (index-of($bodyNames, $sequenceName) ge 1) 
                           then '1' 
                           else 'i'"/>
  </xsl:template>
  ...
  <xsl:template name="configureFootnoteSeparator">
    ...
    <xsl:if test="starts-with($masterName, 'body') or 
                  starts-with($masterName, 'frontmatter') or 
                  starts-with($masterName, 'backmatter')">
  ...
  <xsl:attribute-set name="footnote-separator">
    ...
    <xsl:attribute name="leader-length">4em</xsl:attribute>
  ...
  <xsl:template name="configureHeadersAndFooters">
    ...
    <xsl:if test="not(starts-with($masterName, 'title'))">
  ...
  <xsl:template name="headersAndFooters">
    ...
    <xsl:variable name="chapterTitle">
      <xsl:if test="$pageSequence eq 'part' or 
                    $pageSequence eq 'chapter' or 
                    $pageSequence eq 'appendices' or 
                    $pageSequence eq 'appendix'">
        <xsl:variable name="chapterTitlePrefix" 
                      select="u:shortTitlePrefix(string($topicInfo/@number), 
                                                 $topicInfo)" />

        <xsl:variable name="chapterTitle" 
                      select="u:autoTitle($topicInfo/@title, $topicInfo)" />

        <xsl:sequence select="if ($chapterTitlePrefix ne '')
                              then concat($chapterTitlePrefix,
                                          $title-prefix-separator1, 
                                          $chapterTitle)
                              else string($chapterTitle)"/>
      </xsl:if>
    </xsl:variable>
    ...
    <!-- For a single-sided doc, first-XXX and even-XXX flows don't exist -->
    <xsl:if test="$two-sided eq 'yes'">
  ...
  <xsl:function name="u:evalHeaderOrFooter" as="item()*">
    ...
    <xsl:choose>
      <xsl:when test="$valueSpec ne ''">
        ...
        <!-- Beware that the image path may contain parenthesis. -->
  ...
  <xsl:attribute-set name="header-or-footer">
    ...
    <xsl:attribute name="line-height">1.33</xsl:attribute><!--Not 1.89-->
    <xsl:attribute name="color">#808080</xsl:attribute>
    <xsl:attribute name="border-color">#808080</xsl:attribute>
      ...
      <xsl:when test="$isFooter">
        <fo:block xsl:use-attribute-sets="footer">
          <xsl:if test="$footer-separator eq 'yes'">
            ...
            <xsl:attribute name="padding-top">0.165em</xsl:attribute>
          </xsl:if>
      ...
      <xsl:otherwise>
        <fo:block xsl:use-attribute-sets="header">
          <xsl:if test="$header-separator eq 'yes'">
            <xsl:attribute name="padding-bottom">0.165em</xsl:attribute>
