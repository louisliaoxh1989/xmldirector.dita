...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="proptypehd" use-attribute-sets="stentry">
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="propvaluehd" use-attribute-sets="stentry">
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="propdeschd" use-attribute-sets="stentry">
  </xsl:attribute-set>
