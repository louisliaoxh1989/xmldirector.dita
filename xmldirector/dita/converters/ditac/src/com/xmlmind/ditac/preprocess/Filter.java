...
public final class Filter implements Constants {
        ...
        public Element toElement(Document doc) {
            ...
            if (changeBarProps != null) {
                for (int i = 0; i < changeBarProps.length; i += 2) {
                    flags.setAttributeNS(null, changeBarProps[i], 
                                         changeBarProps[i+1]);
                }
            }
    ...
    /**
     * Specifies the ResourceHandler used by the PreProcessor. Invoked by the
     * {@link PreProcessor}.
     *
    ...
    /**
     * Returns the ResourceHandler used by the PreProcessor.
     * 
    ...
    public static void main(String[] args) {
        ...
        if (usage) {
            System.err.println(
                "usage: java com.xmlmind.ditac.preprocess.Filter [-validate]" +
