...
public final class DOMUtil {
    ...
    public static String toString(Node node) {
        try {
            ...
            // Anyway Java 1.5 implementation seems buggy
    ...
    public static String getXMLLang(Element element) {
        // Note that xml:lang="" is allowed too. It means:
        // from here, no language information is available.
        // But we are not interested in this kind of info.
